...
export class PitchingExportScriptGenerator {
    ...
    getExportWriteScript() {
        ...
        const script = `
${this.cardData.generateLoadExportedDataScript(dataFilter, 'PitchingStats')}
${this.getTournamentPitchingStatsWriteScript()}
        `
    ...
    private getTournamentPitchingStatsWriteScript () {
...
INSERT INTO main.PitchingStats (PtCardID, TeamName, StatsBatchID, ${sourceDatabaseColumnNames})
