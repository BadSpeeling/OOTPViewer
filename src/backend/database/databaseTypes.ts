export interface DataInserterType {

}

export interface PtCard extends DataInserterType {
    CardID: number;
    CardTitle: string;
    CardValue?: number;
    CardType: number;
...
export interface LiveUpdate extends DataInserterType  {
    LiveUpdateID: number;
    EffectiveDate: string;
}

export interface CardMarketValue extends DataInserterType  {
    CardMarketValueID?: number;
    PtCardID?: number;
    BuyOrderHigh?: number;
    SellOrderLow?: number;
    Last10Price?: number;
    "Last10Price(VAR)"?: number;
    Timestamp?: number;
}
